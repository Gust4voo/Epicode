...
console.log(deleteOne("Team 1", false)); 
...
console.log(isThisAnEmail('japao3210@gmail.com')); // true
console.log(isThisAnEmail('non è una email')); // false
...
function whatDayIsIt() {
  ...
  if (daysOfWeek[dayOfWeek] === "Venerdì") {
    return "Venerdì";
  }
  return null;
}
...
const birthday = new Date("2001-03-13");
const isToday = isTodayMyBirthday(birthday);
console.log(isToday);
